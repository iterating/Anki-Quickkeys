...
if [[ $1 == "1" || $1 == "2" || $1 == "3" || $1 == "winmac" || $1 == "mac" || $1 == "chromebook" ]]; then
	...
	yes | cp -rf ./xkeysnail-config/kinto-multikey.py ./xkeysnail-config/kinto-multikey.py.new
	...
	if $vssublime ; then
		perl -pi -e "s/(# )(.*)(- Sublime)/\$2\$3/g" ./xkeysnail-config/kinto-multikey.py.new >/dev/null 2>&1
	fi
fi
...
if [[ $1 == "1" || $1 == "winmac" ]]; then
	...
	perl -pi -e "s/(# )(.*)(# WinMac)/\$2\$3/g" ./xkeysnail-config/kinto-multikey.py.new
	if [[ $dename == "xfce" ]]; then
		perl -pi -e "s/(# )(.*)(# xfce4)/\$2\$3/g" ./xkeysnail-config/kinto-multikey.py.new
		perl -pi -e "s/(\w.*)(# Default not-xfce4)/# \$1\$2/g" ./xkeysnail-config/kinto-multikey.py.new
	fi
elif [[ $1 == "2" || $1 == "mac" ]]; then
	removeAppleKB
	perl -pi -e "s/(# )(.*)(# Mac)/\$2\$3/g" ./xkeysnail-config/kinto-multikey.py.new
	if [[ $dename == "xfce" ]]; then
		perl -pi -e "s/(# )(.*)(# xfce4)/\$2\$3/g" ./xkeysnail-config/kinto-multikey.py.new
		perl -pi -e "s/(\w.*)(# Default not-xfce4)/# \$1\$2/g" ./xkeysnail-config/kinto-multikey.py.new
	fi
elif [[ $1 == "3" || $1 == "chromebook" ]]; then
	perl -pi -e "s/(# )(.*)(# Chromebook)/\$2\$3/g" ./xkeysnail-config/kinto-multikey.py.new
	perl -pi -e "s/(# )(.*)(# xfce4)/\$2\$3/g" ./xkeysnail-config/kinto-multikey.py.new
	perl -pi -e "s/(\w.*)(# Default)/# \$1\$2/g" ./xkeysnail-config/kinto-multikey.py.new
fi

if $rightalt ; then
	perl -pi -e "s/(\w.*)(Multi-language)/# \$1\$2/g" ./xkeysnail-config/kinto-multikey.py.new >/dev/null 2>&1
fi

if [[ $1 == "1" || $1 == "2" || $1 == "3" || $1 == "winmac" || $1 == "mac" || $1 == "chromebook" ]]; then
	mv ./xkeysnail-config/kinto-multikey.py.new ~/.config/kinto/kinto-multikey.py
